...
"""
    ...
    with open(Path('core/adapters/__init__.py'), 'w') as f:
        ...
        f.write('from src.core.adapters.plugin_base import PluginBase\n')
        f.write('from src.core.adapters.plugin_manager import PluginManager\n')
...
def update_app_imports():
    ...
    try:
        ...
        import_block_end = app_content.find("from src.core.notion_client import")
